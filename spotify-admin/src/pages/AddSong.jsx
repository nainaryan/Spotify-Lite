...
const AddSong = () => {
  ...
  const onSubmitHandler = async (e)=>{
    ...
    try {
        ...
        const response = await axios.post(`${url}/api/song/add`,formData) // emd point of api
  ...
  return loading ? (
    ...
    <form onSubmit={onSubmitHandler} className="flex flex-col items-start gap-8 text-gray-600">
      ...
      <button type="submit" className="tect-base bg-black text-white py-2.5 px-14 cursor-pointer">ADD</button>
    </form>
  );
};
